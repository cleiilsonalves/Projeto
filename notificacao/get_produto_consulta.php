...
$sortname = isset($_GET['sidx']) ? $_GET['sidx'] : 'IDLINHA';
...
// Abre JSON
/*
$FileJSON = dirname(__FILE__).'\json\produto'.session_id();
...
*/
session_start();
$conteudoArquivo = $_SESSION['dadosProduto'];
...
foreach($rows as $row){
    ...
    $entry = array('id'=>$row['IDNTOLPRINCIPAL'],
