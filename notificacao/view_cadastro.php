...
/*
        function getModelo() {
            ...
            if (codDpt != '') {
                res = $.post('get_modelo.php', {'codDpt': codDpt}, function (text, status, xml) {
                    jQuery.ajax({
                        type: "GET",
                        datatype: "json",
                        url: "/notificacao/json/modelo$_SESSION['sessionID']?>.json",
        ...
        $(function() {
            ...
            $('#formCadastro').validate({
                ...
                // define messages para cada campo
                    ...
                    modeloCertidao:"Selecione o Modelo",
...
<div class="container">
    ...
    <div class="row col-lg-8 col-md-8  col-sm-8">
        ...
        <?php } ?>
        <hr>
        <form class="form-horizontal" name= "cadastro" id="formCadastro" action="controle_cadastro.php" method="post">
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-4">
                    <input type="text" name="doc" class="form-control"  id="Doc" onblur="validaDoc()">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nomeDevedor" class="form-control" id="nomeDevedor" placeholder="Nome Devedor">
                </div>
            </div>
