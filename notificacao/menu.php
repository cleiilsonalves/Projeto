        ...
        <div class="nav-side-menu">
            ...
            <div class="menu-list">
                ...
                <ul id="menu-content" class="navbar-collapse collapse">
                    ...
                    <li>
                        <a href="#"> <i class="fa fa-search fa-lg"></i>Consultar</a>
                    <li>
                        <a href="#"> <i class="fa fa-pencil-square-o fa-lg"></i>Liberar Notificações</a>
                    </li>
                    </li>
                    ...
                    <ul class="sub-menu collapse" id="conheca">
                        <li class="active"><a href="#">Upload dos Dados Variasves</a></li>
