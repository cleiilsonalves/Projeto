...
$tipo           =$_POST ['modeloNt'];
$destinatario   =$JsonObj1 =  $_POST ['destinatario'];
...
$JsonObj = array(
    ...
    'cidade'        => $cidade,
    'uf'            => $uf,
    'nomedevedor'   => $nomeDevedor,// fazer a alterção de na liberação
    'produto01'     => $produto01,
...
$Campos1  = json_encode($Campos, true );

$JsonObj1 = json_encode($JsonObj, true );
$JsonObj1 = str_replace("/","@@@@",$JsonObj1);
print_r($JsonObj1);

$DadosCad = $Webservice->GravarDadosNTOnline($JsonObj1, $Campos1);
